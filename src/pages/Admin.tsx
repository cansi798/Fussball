...
function einladungsText(name: string, code: string) {
  return [
    ...
    `✅ Eine Mannschaft mit richtiger Torzahl = 2 Punkte`,
    `↗️ Richtige Tendenz (Sieger oder Unentschieden) = 1 Punkt`,
    `❌ Sonst = 0 Punkte`,
    `⚡ K.o.-Spiele: Stand nach Verlängerung; bei Elfmeterschießen +1 Extra-Punkt, wenn du die weiterkommende Mannschaft als Sieger getippt hast`,
    ``,
